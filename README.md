...
<p>Like I mentioned before, something that might give more insight than Outcomes vs Launch Date would be Outcome Rates vs. Launch Date. This would give more insight into the time periods that have the higher percentages of successful campaigns rather than just showing the number of each outcome. Another chart that could be useful is one that compares the time in which the successful campaigns took with the goals.</p>
